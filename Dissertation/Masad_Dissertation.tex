...
\noindent I am grateful to George Mason University itself, which funded this dissertation via a Presidential Scholarship, a summer research grant, and a dissertation completion grant.

\bigskip

\noindent I am indebted to friends and colleagues who provided ideas, feedback, and information throughout the development of this dissertation. In particular, several practitioners provided valuable insight from their own experience with the expected-utility modeling methodology which helped point me in what I hope was the right direction. Errors, of course, are mine alone.
\bigskip

\noindent Finally, a share of the blame for the existence of this dissertation must go to Sarah Wise, who helped get me into this whole computational social science thing in the first place.
...
\include{WarReason/War_Reason}

\include{BDM_Reproduction/BDM_ABM}

\include{ColdWar/ColdWar}
